...
import com.robin.mytea.adapter.GuidePagerAdapter;
import com.robin.mytea.config.MyConfig;
import com.robin.mytea.helper.SharedPreferencesHelper;
...
public class GuideActivity extends Activity {
	...
	private void initLayout() {
		...
		//R.drawable.slidei  slide1,slide2,slide3 绑定三个view 最后添加到数据源
